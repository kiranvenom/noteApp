...
const NoteDetails = () => {
	...
	return (
		<div className='flex justify-center items-center min-h-screen bg-gray-100 flex-col'>
			<div className='w-[90vw] md:w-[60vw] flex justify-end'>
				<Link
					to='/dashboard'
			...
			<div className='bg-white w-[90vw] md:w-[60vw] hover:bg-slate-50 shadow-lg rounded-xl p-6 border border-gray-200 transition-shadow duration-300'>
